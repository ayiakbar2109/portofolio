...
export default function HeroImage() {
  return (
    <section>
      <motion.div
        className="flex flex-col gap-8 lg:grid lg:grid-cols-2 justify-start items-start mt-32"
      ...
      >
        <div className="flex flex-col items-start justify-start gap-2 lg:gap-4">
          ...
          <motion.h1
            className="text-primary font-bold text-4xl lg:text-[3.5rem] lg:leading-[1] xl:text-6xl whitespace-nowrap"
            variants={textVariant(0.7)}
          >
            ayi akbar maulana
          </motion.h1>
          <motion.h1
            className="text-third font-bold text-4xl lg:text-[3.5rem] lg:leading-[1] xl:text-6xl whitespace-nowrap"
            variants={textVariant(0.8)}
          >
            i build <span className="text-secondary">web</span> with love
          </motion.h1>
          <motion.p
            className="text-third font-medium text-lg lg:text-lg lg:w-[90%]"
